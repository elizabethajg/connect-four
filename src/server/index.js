...
(async () => {
  ...
  io.on('connection', (socket) => {
    ...
    // All users are receiving the socket.emit and seeing the same message. How do I ensure that the user who created the server
    // receives the socket.to message
